...
public class LikeMapper {
    public static LikeResponseDTO convertToDTO(Like like, int likesCount) {
        if (like == null) {
            return null;
        ...
        return new LikeResponseDTO(like.getId(), like.getUser().getId(), like.getPost().getId(), likesCount);
    }
}
